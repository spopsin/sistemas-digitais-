...
HD_PWD='E:/SD/trabalho_1_vivado/trabalho_1/trabalho_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neander.vdi -applog -m64 -messageDb vivado.pb -mode batch -source neander.tcl -notrace
