...
HD_PWD='E:/SD/trabalho_1_vivado/trabalho_1/trabalho_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neander.vds -m64 -mode batch -messageDb vivado.pb -notrace -source neander.tcl
